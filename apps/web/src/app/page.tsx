  ...
  return (
    <main className="bg-canvas">
      ...
      <section className="relative isolate flex min-h-[100svh] items-center overflow-hidden">
        {/* Silk + glass-orb WebGL scene fills the hero — the orb replaces the
            old video. Scene is dark, so hero copy below stays cream/cream-tinted. */}
        <InteractiveOrb className="absolute inset-0" />
        ...
        <div className="container-cohere relative z-10 pb-24 pt-40 sm:pt-48 lg:pb-32 lg:pt-56">
          ...
          <Reveal delay={0.15}>
            <div className="mt-10 flex flex-wrap items-center gap-6">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 rounded-[3px] bg-studio-cream px-6 py-3 text-[15px] font-semibold uppercase tracking-[0.05em] text-studio-black transition-colors hover:bg-studio-sienna hover:text-studio-cream"
              >
