    ...
    <main className="p-6 md:p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div>
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-neutral-900 mt-1">Messages</h1>
          ...
          <div className="space-y-2">
            {conversations.map((c) => (
              <Link
                ...
                className="flex items-center justify-between bg-white border border-neutral-200 rounded-lg px-4 py-3.5 hover:border-neutral-300 transition-all"
              >
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {c.unread_count > 0 && (
                      <span className="shrink-0 inline-flex items-center justify-center w-5 h-5 rounded-full bg-neutral-900 text-white text-xs font-bold">
                        {c.unread_count}
                      </span>
                    )}
                  </div>
                ...
                <MessageSquare className="w-4 h-4 text-neutral-300 shrink-0 ml-3" />
              </Link>
            ))}
          </div>
        )}
