  ...
  return (
    <div>
      <button
        onClick={handleStart}
        disabled={loading}
        className="inline-flex items-center gap-1.5 text-sm font-medium text-black bg-cyan-500 rounded-full px-3 py-1.5 hover:bg-cyan-400 disabled:opacity-50 transition-colors"
      >
        {loading ? (
