...
export function OutreachModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl w-full max-w-lg border border-neutral-200">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-neutral-100">
          <div>
            <h2 className="font-semibold text-neutral-900">Reach out to {applicantName}</h2>
            <p className="text-xs text-neutral-500 mt-0.5">Re: {jobTitle}</p>
          </div>
          <button
            onClick={onClose}
        ...
        {sent ? (
          <div className="p-8 text-center">
            <CheckCircle2 className="w-12 h-12 text-neutral-400 mx-auto mb-3" />
            <p className="font-medium text-neutral-900">Outreach recorded!</p>
            <p className="text-sm text-neutral-500 mt-1">
              This has been saved to your outreach history.
            </p>
            <button
              onClick={onClose}
              className="mt-5 px-5 py-2 bg-neutral-900 text-white text-sm font-medium rounded-full hover:bg-neutral-700 transition-colors"
            >
              Done
            </button>
          </div>
          ...
          <div className="p-5 space-y-4">
            ...
            <button
              onClick={handleDraft}
              disabled={drafting}
              className="inline-flex items-center gap-2 text-sm font-medium text-neutral-700 border border-neutral-200 rounded-full px-3 py-1.5 hover:bg-neutral-50 transition-colors"
            >
              {drafting ? (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm resize-none focus:outline-none focus:ring-1 focus:ring-neutral-400"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2 border-t border-neutral-100">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-neutral-900 text-white text-sm font-medium rounded-full hover:bg-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {sending ? (
