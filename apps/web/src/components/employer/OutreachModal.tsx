...
export function OutreachModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 rounded-xl w-full max-w-lg border border-zinc-800">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-zinc-800">
          <div>
            <h2 className="font-semibold text-white">Reach out to {applicantName}</h2>
        ...
        {sent ? (
          <div className="p-8 text-center">
            ...
            <p className="font-medium text-white">Outreach recorded!</p>
            <p className="text-sm text-zinc-400 mt-1">
              This has been saved to your outreach history.
            </p>
            <button
              onClick={onClose}
              className="mt-5 px-5 py-2 bg-cyan-500 text-black text-sm font-medium rounded-full hover:bg-cyan-400 transition-colors"
            >
              Done
            </button>
          </div>
          ...
          <div className="p-5 space-y-4">
            ...
            <button
              onClick={handleDraft}
              disabled={drafting}
              className="inline-flex items-center gap-2 text-sm font-medium text-cyan-400 border border-cyan-500/30 rounded-full px-3 py-1.5 hover:bg-cyan-500/10 transition-colors"
            >
              {drafting ? (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-zinc-700 rounded-lg px-3 py-2 text-sm bg-zinc-900 text-white placeholder:text-zinc-600 resize-none focus:outline-none focus:ring-1 focus:ring-cyan-500/50 focus:border-cyan-500"
              />
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2 border-t border-zinc-800">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500 text-black text-sm font-medium rounded-full hover:bg-cyan-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {sending ? (
